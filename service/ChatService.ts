...
class ChatService {
  private readonly CHAT_URL = "https://maismaes-api-hda7beaud2frbvfz.canadacentral-01.azurewebsites.net/chat";
  ...
  urlArquivo(fileId: string): string {
    return `https://maismaes-api-hda7beaud2frbvfz.canadacentral-01.azurewebsites.net/arquivo/${fileId}`;
  }
