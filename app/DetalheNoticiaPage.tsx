...
export default function DetalheNoticiaPage() {
  ...
  async function carregarNoticia() {
    try {
      const response = await InfoCardService.buscarPorId(id as string);
  ...
  const dataFormatada = new Date(noticia.dataCriacao).toLocaleDateString(
    "pt-BR",
    {
      day: "2-digit",
      month: "long",
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <AppHeader titulo="Notícia" showBack/>
        ...
        <ScrollView contentContainerStyle={styles.contents}>
          ...
          {!!noticia.link && (
            <TouchableOpacity style={styles.botaoLink} onPress={abrirLink}>
              <Ionicons name="open-outline" size={18} color={Colors.branco} />

              <AppText style={styles.textoBotao}>Abrir fonte</AppText>
            </TouchableOpacity>
          )}
        </ScrollView>
      </View>
